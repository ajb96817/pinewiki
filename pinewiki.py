...
def view_journal(username, year, month):
    ...
    app.logger.info('username={}, journal_user.id={}, current_user.user_id={}'.format(username, repr(journal_user.user_id), repr(current_user.user_id)))
    app.logger.info('test={}'.format(journal_user.user_id == current_user.user_id))
